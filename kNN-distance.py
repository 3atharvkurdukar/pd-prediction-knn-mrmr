...
def weighted_knn(X_train, X_test, y_train, y_test):
    ...
    result = []
    for i in range(4, 11):
        mutual_info = fs.mutual_info_classif(X_train, y_train, discrete_features='auto', n_neighbors=i, copy=True, random_state=None)
...
# https://arnabfly.github.io/arnab_blog/fknn/#:~:text=Let%27s%20understand%20fuzzy%20k%2DNN,have%20data%20sets%20with%20classes.&text=There%20are%20three%20classes%20and,and%20P%20using%20Euclidean%20Distance.
